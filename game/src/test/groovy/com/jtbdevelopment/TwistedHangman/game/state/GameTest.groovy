...
class GameTest extends TwistedHangmanTestCase {
    ...
    void testToString() {
        assert new Game(
                ...
                featureData: [(GameFeature.DrawGallows): "y"]).toString() == "Game{id='0a1230000000000000000000', version=23, created=2014-05-30T10:15:30+02:00[Europe/Paris], declined=2013-05-31T10:15:30+02:00[Europe/Paris], lastUpdate=2013-01-31T10:15:30+01:00[Europe/Paris], completed=2014-05-31T10:15:30+02:00[Europe/Paris], rematched=2013-05-29T10:15:30+02:00[Europe/Paris], previousId='033000000000000000000000', gamePhase=Playing, initiatingPlayer=100000000000000000000000, players=[Player{id='100000000000000000000000', source='MADEUP', displayName='1', disabled=false}, Player{id='200000000000000000000000', source='MADEUP', displayName='2', disabled=false}], playerStates=[100000000000000000000000:Accepted], features=[SingleWinner], featureData=[DrawGallows:y], wordPhraseSetter=200000000000000000000000, solverStates=[100000000000000000000000:IndividualGameState{category='', wordPhrase=[], workingWordPhrase=[], maxPenalties=6, moveCount=0, penalties=0, features=[], badlyGuessedLetters=[], guessedLetters=[], featureData=[:], blanksRemaining=0}], playerRunningScores=[100000000000000000000000:5]}"
    }
}
