...
class ManualPlayerMaker {
    public static void main(final String[] args) {
        ...
        Player[] players = [new Player(id: "MANUAL1", disabled: false, displayName: "Manual Player1", source: "MANUAL"),
                            new Player(id: "MANUAL2", disabled: false, displayName: "Manual Player1", source: "MANUAL"),
                            new Player(id: "MANUAL3", disabled: false, displayName: "Manual Player1", source: "MANUAL"),
                            new Player(id: "MANUAL4", disabled: false, displayName: "Manual Player1", source: "MANUAL")]
